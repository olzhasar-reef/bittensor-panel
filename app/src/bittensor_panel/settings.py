"""
Django settings for bittensor_panel project.
"""
...
ROOT_URLCONF = "bittensor_panel.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [root("bittensor_panel/templates")],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
CELERY_BEAT_SCHEDULE = {  # type: ignore
    # 'task_name': {
    #     'task': "bittensor_panel.core.tasks.demo_task",
    #     'args': [2, 2],
    #     'kwargs': {},
...
CELERY_TASK_ROUTES = ["bittensor_panel.celery.route_task"]
